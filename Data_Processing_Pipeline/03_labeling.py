...
PATH_TO_LOAD_ESO = "../Processed_data_new/01_Eso_Extracted"
PATH_TO_LOAD_MF4 = "../Processed_data_new/02_Mf4_Filled"
PATH_TO_SAVE = "../Processed_data_new/03_Labeled"

vehicle_names = ["SEB880", "SEB882", "SEB883", "SEB885", "SEB888", "SEB889"]

with open('../utils/Labels.yaml') as config_file:
